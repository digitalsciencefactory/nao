...
function initMap() {
    ...
    var map = new google.maps.Map(document.getElementById('envoieObservationMap'), {
        center: myLatLng,
        zoom: 10,
        scrollwheel: true,
        styles: [
...
function handleLocationError(browserHasGeolocation, infoWindow, pos) {
    ...
    infoWindow.setContent(browserHasGeolocation ?
        'Erreur: Le service de localisation GPS n\'a pas fonctionné.' :
        'Erreur: Votre navigateur ne supporte pas cette fonctionnalité');
}