...
class appProdDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/dashboard')) {
            ...
            // fn_dashboard_bannir
            if (0 === strpos($pathinfo, '/dashboard/bannir') && preg_match('#^/dashboard/bannir(?:/(?P<id>\\d+))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'fn_dashboard_bannir')), array (  'id' => 0,  '_controller' => 'AppBundle\\Controller\\DashBoardController::bannirAction',));
            }
